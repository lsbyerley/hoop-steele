...
},{}],"src/components/Game.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    pointDiff: function pointDiff(game) {
      var aDiff = game.prediction.away.expectedPointDiff;
      var hDiff = game.prediction.home.expectedPointDiff;
      return aDiff > 0 ? aDiff : hDiff;
    }
  }
};
exports.default = _default;
        var $0add2c = exports.default || module.exports;
      
      if (typeof $0add2c === 'function') {
        $0add2c = $0add2c.options;
      }
    
        /* template */
        Object.assign($0add2c, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "panel game" }, [
    _c("div", { staticClass: "panel-head" }, [
      _c("div", { staticClass: "panel-title left" }, [
        _vm._v(_vm._s(_vm.game.status.detail))
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "panel-title right" }, [
        _vm._v("SHFactor: " + _vm._s(_vm.game.shFactor))
      ])
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "panel-body" }, [
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col col-sm-12 col-md-4" }, [
          _c("div", { staticClass: "row matchup" }, [
            _c("div", { staticClass: "col team visitor" }, [
              _c("div", { staticClass: "team-name" }, [
                _vm._v(_vm._s(_vm.game.away.abbrev))
              ]),
              _vm._v(" "),
              _c("img", {
                staticClass: "team-logo",
                attrs: { src: _vm.game.away.logo }
              }),
              _vm._v(" "),
              _c("div", { staticClass: "team-record" }, [
                _vm._v(
                  "(" +
                    _vm._s(_vm.game.away.totalRecord) +
                    ", " +
                    _vm._s(_vm.game.away.ahRecord) +
                    " Away)"
                )
              ]),
              _vm._v(" "),
              _vm.game.status.state !== "pre"
                ? _c("div", { staticClass: "score" }, [
                    _vm._v(_vm._s(_vm.game.away.score))
                  ])
                : _vm._e()
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "col team home" }, [
              _c("div", { staticClass: "team-name" }, [
                _vm._v(_vm._s(_vm.game.home.abbrev))
              ]),
              _vm._v(" "),
              _c("img", {
                staticClass: "team-logo",
                attrs: { src: _vm.game.home.logo }
              }),
              _vm._v(" "),
              _c("div", { staticClass: "team-record" }, [
                _vm._v(
                  "(" +
                    _vm._s(_vm.game.home.totalRecord) +
                    ", " +
                    _vm._s(_vm.game.home.ahRecord) +
                    " Home)"
                )
              ]),
              _vm._v(" "),
              _vm.game.status.state !== "pre"
                ? _c("div", { staticClass: "score" }, [
                    _vm._v(_vm._s(_vm.game.home.score))
                  ])
                : _vm._e()
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "col details" }, [
              _c("div", { staticClass: "odds" }, [
                _c("div", { staticClass: "title" }, [_vm._v("Spread")]),
                _vm._v(" "),
                _c("div", { staticClass: "value" }, [
                  _vm._v(_vm._s(_vm.game.odds.spread))
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "odds" }, [
                ...
                _vm._v(" "),
                _c("div", { staticClass: "value" }, [
                  _vm._v(_vm._s(_vm.game.odds.total))
                ])
              ])
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "row diffs" }, [
            _c("div", { staticClass: "col col-sm-6" }, [
              _c("div", { staticClass: "tag" }, [
                _vm._v("SPR Diff: " + _vm._s(_vm.game.spreadDiff))
              ])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "col col-sm-6" }, [
              _c("div", { staticClass: "tag" }, [
                _vm._v("TOT Diff: " + _vm._s(_vm.game.totalDiff))
              ])
            ])
          ])
        ]),
          ...
          _c("table", [
            ...
            _c("tbody", [
              _c("tr", [
                ...
                _vm._v(" "),
                _c("td", [
                  _vm._v(_vm._s(_vm.game.prediction.away.winProbability))
                ]),
                _vm._v(" "),
                _c("td", [
                  _vm._v(_vm._s(_vm.game.prediction.home.winProbability))
                ])
              ]),
              _vm._v(" "),
              _c("tr", [
                ...
                _vm._v(" "),
                _c("td", [
                  _vm._v(_vm._s(_vm.game.prediction.away.expectedOutput))
                ]),
                _vm._v(" "),
                _c("td", [
                  _vm._v(_vm._s(_vm.game.prediction.home.expectedOutput))
                ])
              ]),
              _vm._v(" "),
              _c("tr", [
                ...
                _c("td", { attrs: { colspan: "2" } }, [
                  _vm._v(_vm._s(_vm.game.prediction.totalOutput))
                ])
              ]),
              _vm._v(" "),
              _c("tr", [
                ...
                _vm._v(" "),
                _c("td", { attrs: { colspan: "2" } }, [
                  _vm._v(_vm._s(_vm.pointDiff(_vm.game)))
                ])
              ]),
              _vm._v(" "),
              _c("tr", [
                ...
                _c("td", { attrs: { colspan: "2" } }, [
                  _vm._v(
                    _vm._s(_vm.game.prediction.tempoText) +
                      " (" +
                      _vm._s(_vm.game.prediction.expectedTempo) +
                      ")"
                  )
                ])
              ])
          ...
          _c("table", [
            ...
            _c("tbody", [
              _c("tr", [
                _c("td", [_vm._v("Rank")]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(_vm.game.away.kenPom.rank))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(_vm.game.home.kenPom.rank))])
              ]),
              _vm._v(" "),
              _c("tr", [
                _c("td", [_vm._v("Offense")]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(_vm.game.away.kenPom.adjORank))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(_vm.game.home.kenPom.adjORank))])
              ]),
              _vm._v(" "),
              _c("tr", [
                _c("td", [_vm._v("Defense")]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(_vm.game.away.kenPom.adjDRank))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(_vm.game.home.kenPom.adjDRank))])
              ]),
              _vm._v(" "),
              _c("tr", [
                _c("td", [_vm._v("Tempo")]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(_vm.game.away.kenPom.adjT))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(_vm.game.home.kenPom.adjT))])
              ]),
              _vm._v(" "),
              _c("tr", [
                _c("td", [_vm._v("Record")]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(_vm.game.away.kenPom.record))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(_vm.game.home.kenPom.record))])
              ])
            ])
          ])
        ])
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$0add2c', $0add2c);
          } else {
            api.reload('$0add2c', $0add2c);
          }
        }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return _axios.default.get('http://localhost:3000/api/games');
...
exports.default = _default;
        var $b04d84 = exports.default || module.exports;
      
      if (typeof $b04d84 === 'function') {
        $b04d84 = $b04d84.options;
      }
    
        /* template */
        Object.assign($b04d84, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    ...
    _c("main", { staticClass: "main" }, [
      _c("div", { staticClass: "section" }, [
        _c("h1", { staticClass: "h5 games-date" }, [
          _vm._v(_vm._s(_vm.gamesDate))
        ]),
        _vm._v(" "),
        this.dataLoading
          ? _c("div", { staticClass: "progress-bar striped animated" }, [
              _c("span", {
                staticClass: "progress-bar-blue",
    ...
    return _c("nav", { staticClass: "nav" }, [
      _c("div", { staticClass: "nav-container" }, [
        _c("div", { staticClass: "nav-logo" }, [
          _c("a", { attrs: { href: "/" } }, [_vm._v("SteeleHoops")])
        ])
      ])
    ])
  },
        ...
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col col-sm-12" }, [
            _c("div", { staticClass: "footer-text" }, [
              _c("p", [_vm._v("Degenerates rejoice")])
            ])
          ])
        ])
      ]),
      _vm._v(" "),
      _c("p", { staticClass: "copy align-center" }, [
        _vm._v("SteeleHoops - Beat. The. Odds.")
      ])
    ])
  }
]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b04d84', $b04d84);
          } else {
            api.reload('$b04d84', $b04d84);
          }
        }
...
},{"@babel/runtime/regenerator":"node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"node_modules/@babel/runtime/helpers/asyncToGenerator.js","axios":"node_modules/axios/index.js","./components/Game":"src/components/Game.vue","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","./assets/fonts/ez-sans-light.woff2":[["ez-sans-light.178de41c.woff2","src/assets/fonts/ez-sans-light.woff2"],"src/assets/fonts/ez-sans-light.woff2"],"./assets/fonts/ez-sans-medium.woff2":[["ez-sans-medium.3b882f4f.woff2","src/assets/fonts/ez-sans-medium.woff2"],"src/assets/fonts/ez-sans-medium.woff2"],"./assets/fonts/ez-sans-bold.woff2":[["ez-sans-bold.cc64475e.woff2","src/assets/fonts/ez-sans-bold.woff2"],"src/assets/fonts/ez-sans-bold.woff2"],"vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
